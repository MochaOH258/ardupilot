...
bool ModeCustom1::init(bool ignore_checks)
{
...
void ModeCustom1::GeneratePath(){
    float radius_cm = 2000.0;
...
autopilot_yaw_mode ModeCustom1::get_default_auto_yaw_mode(bool rtl) const
{
...
void ModeCustom1::guided_pos_control_start()
{
...
void ModeCustom1::guided_pos_control_run()
{
...
void ModeCustom1::set_auto_yaw_mode(autopilot_yaw_mode yaw_mode)
{
...
// 100hz update rate
float ModeCustom1::get_auto_heading()
{
    switch (sub.auto_yaw_mode) {
